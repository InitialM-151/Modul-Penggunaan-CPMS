...
- Dari halaman ini, Anda dapat menavigasikan diri Anda ke berbagai menu lainnya melalui *Sidebar* (menu samping).

> ![Gambar Dashboard Guru](isi_dengan_path_atau_url_gambar_dashboard)
...
> ![Gambar Al-Quran dan Jadwal Sholat](isi_dengan_path_atau_url_gambar_fitur_keagamaan)
...
1. Buka menu **Akademik > Presensi**.
2. Pilih Jadwal Mengajar/Kelas yang sedang berlangsung.
3. Tandai kehadiran masing-masing siswa (Hadir, Izin, Sakit, atau Alpa).
4. Klik **Simpan** untuk merekam data kehadiran ke sistem.

> ![Gambar Halaman Presensi](isi_dengan_path_atau_url_gambar_presensi)

### B. Penilaian (Nilai Siswa)
...
> ![Gambar Halaman Nilai](isi_dengan_path_atau_url_gambar_nilai)
...
3. **Jurnal Kelas**: Memantau catatan jurnal yang terjadi di suatu kelas secara keseluruhan.
4. Jurnal dapat diekspor/diunduh sebagai laporan.

> ![Gambar Jurnal Mengajar](isi_dengan_path_atau_url_gambar_jurnal)
...
> ![Gambar Halaman Wali Kelas](isi_dengan_path_atau_url_gambar_wali_kelas)
